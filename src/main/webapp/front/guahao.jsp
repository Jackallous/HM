...
<div class="panel admin-panel">
    <div class="panel-head">
        <form method="post" action="${pageContext.request.contextPath}/schedule/getScheduleListByPid" id="listform">
...
<%--                            默认是一保证合法--%>
                ...
                <if condition="$iscid eq 1">
                    <li>
                        <%--                        设置的是用户请求的当前页--%>
                            <select name="cid" class="input w50" style="width:200px; line-height:17px;" required>
...
<%--            <th width="10%">工号</th>--%>
        ...
        <volist name="list" id="vo">
            ...
            <tr >
                ...
                <td >${h.shiftTime}</td>
                <td>${h.sum}</td>
                <td><div class="button-group"> <a class="button border-main" href="${pageContext.request.contextPath}/appointment/addAppointment?dname=${h.departmentName}&patid=${patients.patientId}&date=${h.date}&time=${h.shiftTime}"><span class="icon-edit"></span> 挂号</a> <a class="button border-red" href="javascript:void(0)" onclick="deleteById(${sche.scheduleId})"> <span class="icon-trash-o"></span> 取消</a></div></td>
            </tr>
            </c:forEach>
            <tr>
                <td colspan="5">
